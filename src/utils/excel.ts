...
// Auto-mapping logic — 严格对应考试要求的 10 个标准字段
export const standardFields = [
  ...
  { key: "receiverName", label: "收件人姓名", aliases: ["收货人", "收件人", "收货人姓名", "收件人姓名", "收货联系人", "联系人"], required: false },
  { key: "receiverPhone", label: "收件人电话", aliases: ["收货电话", "收件电话", "收件人联系方式", "收货人电话", "收件人电话", "联系电话"], required: false },
  { key: "receiverAddress", label: "收件人地址", aliases: ["收货地址", "收件地址", "收货人地址", "收件人地址", "配送地址"], required: false },
  ...
  { key: "quantity", label: "SKU发货数量", aliases: ["发货数量", "发货数量*", "出库数量", "数量", "件数", "实发数量", "发件数"], required: true },
